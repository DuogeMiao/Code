...
import com.tsingshan.quartz.mapper.SysJobLogMapper;
...
public class SysJobLogServiceImpl implements ISysJobLogService
{
    ...
    @Override
    public List<SysJobLog> selectExport(String ids) {
        return jobLogMapper.selectExport(Convert.toStrArray(ids));
    }
}
