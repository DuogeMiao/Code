...
import com.tsingshan.system.mapper.SysLogininforMapper;
...
public class SysLogininforServiceImpl implements ISysLogininforService
{
    ...
    @Override
    public List<SysLogininfor> selectExport(String ids) {
        return logininforMapper.selectExport(Convert.toStrArray(ids));
    }
}
