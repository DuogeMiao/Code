    ...
    $.extend({
    	...
    	table: {
            ...
            init: function(options) {
				...
				$.table._responseHandler = $.common.isEmpty(options.responseHandler) ? $.table.responseHandler : options.responseHandler;
                ...
                $('#bootstrap-table').bootstrapTable({
                    ...
                    responseHandler: $.table._responseHandler            // 回调函数
                });
            },
            // 查询条件
