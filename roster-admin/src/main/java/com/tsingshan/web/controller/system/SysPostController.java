...
public class SysPostController extends BaseController
{
    ...
    {
        List<SysPost> list = postService.selectExport(ids);
     ...
     * 根据Id查询岗位
     */
    @Log(title = "根据岗位Id查询信息", businessType = BusinessType.OTHER)
    @PostMapping("/postId")
    @ResponseBody
    public AjaxResult edit(Long postId)
    {
        SysPost sysPost = postService.selectPostById(postId);
        return AjaxResult.success(sysPost);
    }
}
